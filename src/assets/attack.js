...
class Move {
  constructor(index, dmg, status, cost, effect, area, target) {
    // user input values
    this.index = index;
    this.dmg = dmg;
    this.status = status;
...
// fire moves
const fire1 = new Move(0, 100, 0, 10, 10, 'single', 'enemy');
const fire2 = new Move(1, 100, 0, 10, 10, 'single', 'enemy');
const fire3 = new Move(2, 0, 0.20, 10, 10, 'single', 'ally');
const fire4 = new Move(3, 100, 0, 10, 10, 'single', 'enemy');

// water moves
const water1 = new Move(0, 100, 0, 10, 10, 'single', 'enemy');
const water2 = new Move(1, 100, 0, 10, 10, 'single', 'enemy');
const water3 = new Move(2, 0, 0.20, 10, 10, 'single', 'ally');
const water4 = new Move(3, 100, 0, 10, 10, 'single', 'enemy');
